...
%envy plot
t=tiledlayout(1,3);
title1=strcat('Scenario A, n= ',num2str(n), ', d= ',num2str(d),', uniform valuations. Comp. times: MCT+=',num2str(sum(sum(time_mc,2))/SIM+add,'%.2f'),' sec., SPL=',num2str(mean(time_sp),'%.2g'),' sec.');
...
saveas(gcf,'../Figures/FigureAU.pdf')
