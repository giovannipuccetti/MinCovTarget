...
%%%%%%% MAXIMUM TOTAL WELFARE ALGORITHM  %%%%%%%
...
%find (exact) maximum total welfare and all allocations attaining it
util_o=max(util_bf);
...
%change Spliddit constraints to maxime total welfare
...
%for envy first, then max Nash welfare
tic
...
%values
mean(envy_mc);
%maximum level of total welfare attainable by a no-envy allocation
