% This code plots Figure 6 about the average computation time in seconds, 
...
for jj=1:res
for uu=1:SIM
%%%over all minimal envy choose one with max total welfare
